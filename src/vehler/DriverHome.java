...
public class DriverHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 420, -1, -1));
        ...
        jPanel2.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 500, 130, 40));
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
       ...
       {
           DriverCarAC driverac=new DriverCarAC();
        driverac.insertAvailablity(iidd, dname,plateNo, carid, carName, yes);
           
       }
         else if(type=="Car(Premium)")
       {
           DriverCarPr driverpr=new DriverCarPr();
        driverpr.insertAvailablity(iidd, dname,plateNo, carid, carName, yes);
           
       }
          else if(type=="Bike")
       {
           DriverBike driverb=new DriverBike();
        driverb.insertAvailablity(iidd, dname,plateNo, carid, carName, yes);
