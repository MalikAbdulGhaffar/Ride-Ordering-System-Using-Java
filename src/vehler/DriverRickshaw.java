...
public class DriverRickshaw implements Driver {
    ...
    DriverRickshaw(String name,String fatherName,String age,String gender, String username,String password,String type,String cnic,String contactNo,String dob)
    {
        this.name=name;
        ...
        flag = conn.InsertUpdateDelete(sql);
           if(flag == 1){
               JOptionPane.showMessageDialog(null, "YOU HAVE BEEN ASSIGNED DRIVER. HIS DRIVER ID IS :  "+i);
                ...
                JOptionPane.showMessageDialog(null, " Sorry, No Rickshaw Available " );
           }
        }
        catch(Exception e){
