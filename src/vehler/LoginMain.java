...
public class LoginMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        forgotButton.setBounds(1140, 520, 0, 0);
...
//            DriverCarAC ac = new DriverCarAC();
//            DriverCarPr pr = new DriverCarPr();
            ...
            else if(LoginAs.equals("Driver"))
            {
                ...
                if(checking.chkDriverPass(iidd, pass))
                {
                    ...
                    else if(answer.equals("Car(AC)"))
                    {
                        DriverCarAC acc=new DriverCarAC();
                        String dname=acc.getRDriverName(iidd);
                        int carid = acc.getRCarId(iidd);
                        String carName=acc.getRCarName(iidd);
                        String plateNo=acc.getRCarPlate(iidd);
                        String type="Car(AC)";
                        DriverHome dh=new DriverHome(iidd,dname,type,plateNo,carid,carName);
                        this.setVisible(false);
                     ...
                     else if(answer.equals("Car(Premium)"))
                    {
                        DriverCarPr prr =new DriverCarPr();
                        String dname=prr.getRDriverName(iidd);
                        int carid = prr.getRCarId(iidd);
                        String carName=prr.getRCarName(iidd);
                        String plateNo=prr.getRCarPlate(iidd);
                        String type="Car(Premium)";
                        DriverHome dh=new DriverHome(iidd,dname,type,plateNo,carid,carName);
                        this.setVisible(false);
                      ...
                      else if(answer.equals("Rickshaw"))
                    {
                     ...
                     else if(answer.equals("Bike"))
                    {
                        DriverBike bk=new DriverBike();
                        String dname=bk.getRDriverName(iidd);
                        int carid=bk.getBBikeId(iidd);
                        String carName=bk.getBBikeName(iidd);
                        String plateNo=bk.getBBikePlate(iidd);
                        String type="Bike";
                        DriverHome dh=new DriverHome(iidd,dname,type,plateNo,carid,carName);
                        this.setVisible(false);
...
//                     else if(answer.equals("Car(AC)"))
//                    {
//                        String dname=ac.getRDriverName(iidd);
//                        int carid=ac.getRCarId(iidd);
//                        String carName=ac.getRCarName(iidd);
//                        String type="Car(AC)";
//                        String plateNo=ac.getRCarPlate(iidd);
//                        DriverHome dh=new DriverHome(iidd,dname,type,plateNo,carid,carName);
//                        this.setVisible(false);
//
//                        dh.setVisible(true);
...
//                     else if(answer.equals("Car(Premium)"))
//                    {
//                        String dname=pr.getRDriverName(iidd);
//                        int carid=pr.getRCarId(iidd);
//                        String carName=pr.getRCarName(iidd);
//                        String type="Car(Premium)";
//                        String plateNo=pr.getRCarPlate(iidd);
//                        DriverHome dh=new DriverHome(iidd,dname,type,plateNo,carid,carName);
//                        this.setVisible(false);
//
//                        dh.setVisible(true);
