...
public class Passenger {
    ...
    private String name,fName,age,gender,user,pass,cnic,contactNo,dob;
    Passenger()
    {
        
    }
    Passenger(String name,String fName,String age, String gender,String user,String pass,String cnic,String contactNo,String dob)
    {
        this.name=name;
        this.fName=fName;
        this.age=age;
...
//    }
     ...
     public void addPassPass()
    {
        ...
        DbConnection conn = new DbConnection();
        conn.OpenConnection();
        String sql="Insert into PassengerT (PID, PPass, PName,PFName,PAge, PGender,CNIC,ContactNo,DOB) values '"
                + getUser()+ "','"
                    + getPass()+ "','"
                    + getPname()+ "','"
                    + getFname()+ "','"
