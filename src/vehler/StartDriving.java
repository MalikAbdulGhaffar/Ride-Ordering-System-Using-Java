...
public class StartDriving extends javax.swing.JFrame {
    ...
    private void nextButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextButtonActionPerformed
        ...
        else if(type=="Car(AC)")
       {
        ...
        driverac.insertAvailablity(userName, name,plateNo, carId, carName, akbar);
           
       }
        else if(type=="Car(Premium)")
       {
           DriverCarPr driverpr=new DriverCarPr();
        driverpr.insertAvailablity(userName, name,plateNo, carId, carName, akbar);
           
       }
        else if(type=="Bike")
       {
           DriverBike driverbk=new DriverBike();
        driverbk.insertAvailablity(userName, name,plateNo, carId, carName, akbar);
