...
public class DriverCarPr implements Driver {
    ...
    DriverCarPr(String name,String fatherName,String age,String gender, String username,String password,String type,String cnic,String contactNo,String dob)
    {
        this.name=name;
    ...
    public boolean ConfirmCurrentRide(String username)
    {
        ...
        try{
            conn.OpenConnection();
            String sql="Select MAX(RideStatus) AS RideStatus FROM DriverCarPremiumRT where Username = '" + username + "'";
...
//           conn.CloseConnection();
    ...
    public String getRType(String username)
    {
        ...
        DbConnection conn = new DbConnection();
        conn.OpenConnection();
        String sql="Select VehicleType from DriverCarPremiumT where DriverUsername = '"+ username + "'";
        rst= conn.GetData(sql);      
    ...
    public void insertDriverCarData(String driverUsername,String driverName,String carPlate,String type, int carId, String carName)
    {
        ...
        DbConnection conn = new DbConnection();
        conn.OpenConnection();
        String sql="Insert into DriverCarPremiumT (DriverUsername, DriverName,CarPlate,VehicleType, CarID, CarName) values '"
                    + driverUsername+ "','"
                    + driverName+ "','"
                    + type + "','"
                   + carPlate+ "','"
    ...
    public String getRDriverName(String username)
    {
        ...
        DbConnection conn = new DbConnection();
        conn.OpenConnection();
        String sql="Select DriverName from DriverCarPremiumT where DriverUsername = '"+ username + "'";
        rst= conn.GetData(sql);      
    ...
    public String getRRDriverName(int Id)
    {
        ...
        DbConnection conn = new DbConnection();
        conn.OpenConnection();
        String sql="Select DriverName from DriverCarPremiumRT where ID = '"+ Id + "'";
        rst= conn.GetData(sql);      
    ...
    public int getRCarId(String username)
    {
        ...
        DbConnection conn = new DbConnection();
        conn.OpenConnection();
        String sql="Select CarID from DriverCarPremiumT where DriverUsername = '"+ username + "'";
        rst= conn.GetData(sql);      
    ...
    public String getRCarName(String username)
    {
        ...
        DbConnection conn = new DbConnection();
        conn.OpenConnection();
        String sql="Select CarName from DriverCarPremiumT where DriverUsername = '"+ username + "'";
        rst= conn.GetData(sql);      
     ...
     public String getRRCarName(int id)
    {
        ...
        DbConnection conn = new DbConnection();
        conn.OpenConnection();
        String sql="Select CarName from DriverCarPremiumRT where ID = '"+ id + "'";
        rst= conn.GetData(sql);      
    ...
    public void insertAvailablity(String driverUsername,String driverName,String plateNo, int carId, String carName,int avail)
    {
        ...
        DbConnection conn = new DbConnection();
        conn.OpenConnection();
        String sql="Insert into DriverCarPremiumRT (Username, DriverName,CarPlate, CarId, CarName,DriverAvail) values '"
                    + driverUsername+ "','"
                    + driverName+ "','"
                + plateNo+ "','"
                    + carId+ "','"
        ...
        DbConnection conn = new DbConnection();
        conn.OpenConnection();
        String sql="SELECT ID FROM DriverCarPremiumRT where Username = '"+ driverUsername + "'";
        rst= conn.GetData(sql);      
...
//           conn.CloseConnection();
 ...
 int total=0;
        ...
        DbConnection conn = new DbConnection();
        conn.OpenConnection();
        String sql="SELECT TOP 1 ID FROM DriverCarPremiumRT ORDER BY ID DESC"; 
        rst= conn.GetData(sql);      
...
//           conn.CloseConnection();
        ...
        DbConnection conn = new DbConnection();
        conn.OpenConnection();
        String sql="Select DriverAvail from DriverCarPremiumRT where ID = '"+ i + "'"; 
        rst= conn.GetData(sql);      
...
//           conn.CloseConnection();
        ...
        try{
        conn.OpenConnection();
        String sql = "UPDATE DriverCarPremiumRT SET DriverAvail = '"+ newAss +"' where ID = '"+i+ "'";
...
//           conn.CloseConnection();
        ...
        DbConnection comm = new DbConnection();
        conn.OpenConnection();
        String sql = "UPDATE DriverCarPremiumRT SET PName = '"+ pname +"' where ID = '"+i+ "'";
        ...
        public String getRCarPlate(String username)
    {
        ...
        DbConnection conn = new DbConnection();
        conn.OpenConnection();
        String sql="Select CarPlate from DriverCarPremiumT where DriverUsername = '"+ username + "'";
        rst= conn.GetData(sql);      
