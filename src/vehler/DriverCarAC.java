...
public class DriverCarAC implements Driver {
    ...
    DriverCarAC(String name,String fatherName,String age,String gender, String username,String password,String type,String cnic,String contactNo,String dob)
    {
        this.name=name;
...
//        String sqlBill = "Select MAX(BillNumber) AS BillNumber FROM BillT where PID = '" + PID + "'"  ;
        try{
            conn.OpenConnection();
            String sql="Select MAX(RideStatus) AS RideStatus FROM DriverCarACRT where Username = '" + username + "'";
...
//           conn.CloseConnection();
    ...
    public String getRType(String username)
    {
        ...
        DbConnection conn = new DbConnection();
        conn.OpenConnection();
        String sql="Select VehicleType from DriverCarACT where DriverUsername = '"+ username + "'";
        rst= conn.GetData(sql);      
    ...
    public void insertDriverCarData(String driverUsername,String driverName,String carPlate,String type, int carId, String carName)
    {
        ...
        DbConnection conn = new DbConnection();
        conn.OpenConnection();
        String sql="Insert into DriverCarACT (DriverUsername, DriverName,CarPlate,VehicleType, CarID, CarName) values '"
                    + driverUsername+ "','"
                    + driverName+ "','"
                    + type + "','"
                + carPlate+ "','"
    ...
    public String getRDriverName(String username)
    {
        ...
        DbConnection conn = new DbConnection();
        conn.OpenConnection();
        String sql="Select DriverName from DriverCarACT where DriverUsername = '"+ username + "'";
        rst= conn.GetData(sql);      
    ...
    public String getRRDriverName(int Id)
    {
        ...
        DbConnection conn = new DbConnection();
        conn.OpenConnection();
        String sql="Select DriverName from DriverCarACRT where ID = '"+ Id + "'";
        rst= conn.GetData(sql);      
    ...
    public int getRCarId(String username)
    {
        ...
        DbConnection conn = new DbConnection();
        conn.OpenConnection();
        String sql="Select CarID from DriverCarACT where DriverUsername = '"+ username + "'";
        rst= conn.GetData(sql);      
    ...
    public String getRCarName(String username)
    {
        ...
        DbConnection conn = new DbConnection();
        conn.OpenConnection();
        String sql="Select CarName from DriverCarACT where DriverUsername = '"+ username + "'";
        rst= conn.GetData(sql);      
     ...
     public String getRRCarName(int id)
    {
        ...
        DbConnection conn = new DbConnection();
        conn.OpenConnection();
        String sql="Select CarName from DriverCarACRT where ID = '"+ id + "'";
        rst= conn.GetData(sql);      
    ...
    public void insertAvailablity(String driverUsername,String driverName,String plateNo, int carId, String carName,int avail)
    {
        ...
        DbConnection conn = new DbConnection();
        conn.OpenConnection();
        String sql="Insert into DriverCarACRT (Username, DriverName,CarPlate, CarId, CarName,DriverAvail) values '"
                    + driverUsername+ "','"
                    + driverName+ "','"
                + plateNo+ "','"
                    + carId+ "','"
        ...
        DbConnection conn = new DbConnection();
        conn.OpenConnection();
        String sql="SELECT ID FROM DriverCarACRT where Username = '"+ driverUsername + "'";
        rst= conn.GetData(sql);      
...
//           conn.CloseConnection();
 ...
 int total=0;
        ...
        DbConnection conn = new DbConnection();
        conn.OpenConnection();
        String sql="SELECT TOP 1 ID FROM DriverCarACRT ORDER BY ID DESC"; 
        rst= conn.GetData(sql);      
...
//           conn.CloseConnection();
        ...
        DbConnection conn = new DbConnection();
        conn.OpenConnection();
        String sql="Select DriverAvail from DriverCarACRT where ID = '"+ i + "'"; 
        rst= conn.GetData(sql);      
...
//           conn.CloseConnection();
        ...
        try{
        conn.OpenConnection();
        String sql = "UPDATE DriverCarACRT SET DriverAvail = '"+ newAss +"' where ID = '"+i+ "'";
        ...
        conn.OpenConnection();
        String sql = "UPDATE DriverCarACRT SET PUsername = '"+ pusername +"',Fromm ='"+currentLocation+"',Too='"+finalLocation+"' where ID = '"+i+ "'";
...
//           conn.CloseConnection();
        ...
        DbConnection comm = new DbConnection();
        conn.OpenConnection();
        String sql = "UPDATE DriverCarACRT SET PName = '"+ pname +"' where ID = '"+i+ "'";
        ...
        public String getRCarPlate(String username)
    {
        ...
        DbConnection conn = new DbConnection();
        conn.OpenConnection();
        String sql="Select CarPlate from DriverCarACT where DriverUsername = '"+ username + "'";
        rst= conn.GetData(sql);      
